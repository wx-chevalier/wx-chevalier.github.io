...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/ae2970d80a119cd341ef31c684bfac49.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/cccbc03192af67a089b53d7940659505.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/a45c8066f935c6f29d00a95e36cb6662.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/8deca8a84f06466155d2d8d53d26e05d.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/1653ec3b8eb718ca817d3423ae3ca643.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/cb041c33b65e17600842ebf87174c4f2.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/140529e4d7531babb5ba21778cd88bc3.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/19cbb2d356a2a6e0f35aa2a946b23a2a.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/27afdd27f45ad8ddf78677af2a3eeaf8.png)
...
![nn-](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/rnn-f.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/998c7af4f90cd0de0c88f138b61f0168.png)

在之前你已经见过对于前向传播（上图蓝色箭头所指方向）怎样在神经网络中从左到右地计算这些激活项，直到输出所有地预测结果。而对于反向传播，我想你已经猜到了，反向传播地计算方向（上图红色箭头所指方向）与前向传播基本上是相反的。

![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/ad9dd74b6ce9bcea14baa289df530d6b.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/71a0ed918704f6d35091d8b6d60793e4.png)
...
![nn_cell_backpro](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/rnn_cell_backprop.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/329b0748f7282efc206ea8de6a709833.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/14e1df0a7a8cdd1584b2e92e87e23aa7.png)

为了完整性，还要补充一个“**一对一**”（**one-to-one**）的结构（上图编号 3 所示），这个可能没有那么重要，这就是一个小型的标准的神经网络，输入$x$然后得到输出$y$，我们这个系列课程的前两个课程已经讨论过这种类型的神经网络了。

![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/db580f1dfd6095d672fc62cce74ce5e2.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/1daa38085604dd04e91ebc5e609d1179.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/fa17a85c0e7d9b14633013f2223c877b.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/54dfcac1220e3cf567a2c656383e40ec.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/986226c39270a1e14643e8658fe6c374.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/794b8461aeb485ee61c368c90738523e.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/8b901fc8fcab9e16b1fe26b92f4ec546.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/1d31771da8ced333968541fbbf67e6f1.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/4c7e0878e85865c8fed558375e14b938.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/8fb1c4afe30b7a0ede26522b355068ba.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/ac5d647140997ba713c376fb097ea0e2.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/db720dae1606767241df59d8fd6079ee.png)

你已经见过了这个公式，$a^{< t >} = g(W_{a}\left\lbrack a^{< t - 1 >},x^{< t >}\right\rbrack +b_{a})$，在**RNN**的时间$t$处，计算激活值。我把这个画个图，把**RNN**的单元画个图，画一个方框，输入$a^{<t-1>}$（上图编号 1 所示），即上一个时间步的激活值，再输入$x^{<t>}$（上图编号 2 所示），再把这两个并起来，然后乘上权重项，在这个线性计算之后（上图编号 3 所示），如果$g$是一个**tanh**激活函数，再经过**tanh**计算之后，它会计算出激活值$a^{<t>}$。然后激活值$a^{<t>}$将会传**softmax**单元（上图编号 4 所示），或者其他用于产生输出$y^{<t>}$的东西。就这张图而言，这就是**RNN**隐藏层的单元的可视化呈现。我向展示这张图，因为我们将使用相似的图来讲解门控循环单元。![1521560729](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/1521560729.png)

![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/13cee4a2d0ad3897924c22d729c5b02d.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/5e55fb9f6de649031e7f9a4b249f4fea.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/32f3b94e4e4523bc413d9687ec29e801.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/cfa628f62f1c57ee6213793a438957a3.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/c1df3f793dcb1ec681db6757b4974cee.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/daf9e8fa30888b6a1b407ca6ea303984.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/523650730db3f0d5c05a7192da02f878.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/9456d50c55cf0408a3fb2b6e903d85d6.png)
...
![ST](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/LSTM.png)

![STM_rn](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/LSTM_rnn.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/63be3fd3701604f94b45a08f1d8b460d.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/48c787912f7f8daee638dd311583d6cf.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/053831ff43d039bd5e734df96d8794cb.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/8378c2bfe73e1ac9f85d6aa79b71b5eb.png)
...
![](https://assets.ng-tech.icu/book/Andrew-Ng-DeepLearning-AI/455863a3c8c2dfaa0e5474bfa2c6824d.png)
